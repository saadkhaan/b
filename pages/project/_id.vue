<template>
    <div class="content-wrap antialiased">
        ...
        <header class="relative p-12 xl:pt-64 p-header">
              ...
              <div class="flex relative">
                <h3 class="p-title-fraction first">
                  <span>
                    <span class="scene-element text-white ajax-slidebottom" v-if="project.title1">{{ project.title1 }}</span>
              ...
              <div class="flex relative">
                <h3 class="p-title-fraction second">
                  <span>
                    <span class="scene-element text-white ajax-slidebottom" v-if="project.title2">{{ project.title2 }}</span>
                  </span>
                </h3>
              </div>
        ...
        <section class="container mx-auto mt-32 md:mt-256">
          ...
          <div v-for="img in project.allImages" v-if="img.image" class="mx-auto md:w-9/12 p-12 mt-32 md:mt-32 md:mb-64 imgList">
            <div>
...
.p-header h3.second, .p-header h3.third {
  z-index: 5000;
}
