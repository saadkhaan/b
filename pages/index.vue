    ...
    <div id="main" class="antialiased">
      <section class="container mx-auto pt-12 lg:py-64 text-center md:text-left">
        <div class="md:w-9/12 md:ml-auto">
          ...
          <div
            class="flex md:w-9/12 sk-r-xl sk-os-1 text-xl md:text-6xl leading-relaxed md:leading-tight text-white font-medium tracking-wide p-4 md:p-0"
            id="about-text"
          >
            <p>
              I am a designer and front-end developer. Specializing in responsive Web design, modern CSS and progressive enhancement.
              <br />I work with my clients to create interfaces and design systems that work for everyone, and that are optimized for accessibility and speed. Find out more about my
              <span>
                <a href="#work">work</a>
              </span> or
              <span>
      ...
      <section class="container mx-auto portfolio mt-20 uppercase" id="work">
        <div class="md:w-9/12 ml-6 md:ml-auto md:p-0">
          ...
          <h2
            class="font-extrabold text-white text-center md:text-left text-5xl md:text-lg uppercase"
            data-splitting
          >Portfolio</h2>
        </div>
...
export default {
    ...
    meta: [
      {
        ...
        name: "description",
        content:
          "I am a front-end web developer having experience of working with HTML, CSS and JavaScript & web frameworks like vue js, react js and svelte js"
      }
    ]
  },
  ...
  methods: {
    textAnim() {
      ...
      tl.to("#s_1_", 0.5, { fill: "white", stroke: "none" }, "-=.3");
      tl.to("#k_1_", 0.5, { fill: "gray", stroke: "none" }, "-=.3");
      tl.staggerFrom(".hidetext", 1, { y: "130%", ease: Power4.easeOut }, 0.5);
      tl.from(
        "#about-text",
        0.5,
        { alpha: 0, y: 50, ease: Power1.easeOut },
        "-=.5"
      );
    }
  },
